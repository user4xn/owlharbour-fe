...
<template>
  <div class="flex justify-center items-center py-25 mx-5 md:mx-20">
    <DefaultAuthCard class="flex-1" subtitle="Pleas login to continue" title="Log In to Owl Harbour">
